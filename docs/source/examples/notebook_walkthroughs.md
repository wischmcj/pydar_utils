...
```bash
git clone https://github.com/wischmcj/pydar-utils.git
cd pydar-utils/docs/source/examples/
```

Note that if you're running locally, in order to run the code in the workflows, you will also need to install the canoPyHydro package from pip. Please refer to the [getting started page](https://pydar-utils.readthedocs.io/en/latest/getting_started.html) for help getting started.
