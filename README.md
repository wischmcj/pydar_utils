...
pydar_utils is a Python library for processing Terrestrial Laser Scanning (TLS) LiDAR point clouds and generating Quantitative Structural Models (QSM) of trees. The library provides comprehensive tools for tree isolation, structural analysis, and 3D geometry.reconstruction from point cloud data.
...
Algorithm parameters can be customized in `pydar_utils_config.toml`:
...
If you use pydar_utils in your research, please cite:
```
